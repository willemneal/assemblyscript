...
import * as assemblyscript from "../dist/assemblyscript";
...
function resolveFile(readFile: (path: string, baseDir?: string) => string | null, path: string, baseDir?: string): [string, string] {
...
function resolveLibFile(customLibDirs: string[], readFile: ReadFile, path: string, baseDir?: string): [string, string] {
