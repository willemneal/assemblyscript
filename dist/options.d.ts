...
export declare const parse: (argv: string[], config: optionsUtil.Config) => Result;
export declare const help: (config: Options, options?: optionsUtil.HelpOptions) => string;
/** Parsing result. */
